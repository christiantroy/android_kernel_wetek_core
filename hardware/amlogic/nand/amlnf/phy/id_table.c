...
/***for MLC nand***/
	...
	{"E revision 1Ynm NAND 8GiB H27UCG8T2E",	{NAND_MFR_HYNIX, 0xde, 0x14, 0xA7, 0x42, 0x4A}, 16384, 8192, 0x400000, 1664, 1, 16, 15, 0,HYNIX_1YNM, NAND_MULTI_PLANE_MODE },
	{"E revision 1Ynm NAND 8GiB H27UCG8T2ETR",	{NAND_MFR_HYNIX, 0xde, 0x94, 0xA7, 0x42, 0x48}, 16384, 8192, 0x400000, 1664, 1, 16, 15, 0,HYNIX_1YNM, NAND_MULTI_PLANE_MODE },	//without cache program, vccq must be 3.3v.
	{"D revision 1Ynm NAND 4GiB H27UBG8T2D",	{NAND_MFR_HYNIX, 0xd7, 0x14, 0x9E, 0x34, 0x4A}, 8192, 4096, 0x200000, 832, 1, 16, 15, 0,HYNIX_1YNM, NAND_MULTI_PLANE_MODE },
#endif
#ifdef NEW_NAND_SUPPORT	
	...
	{"A serials vccq=1.8v  NAND 8GiB TC58TEG6DDKTA00 ", {NAND_MFR_TOSHIBA, 0xDE, 0x94, 0x93, 0x76, 0x50}, 16384, 8192, 0x400000, 1280, 1, 20, 25, 0, TOSHIBA_A19NM, NAND_MULTI_PLANE_MODE },
	{"A serials vccq=3.3v  NAND 8GiB TC58TEG6DDKTA00 ", {NAND_MFR_TOSHIBA, 0xDE, 0x94, 0x93, 0x76, 0x58}, 16384, 8192, 0x400000, 1280, 1, 20, 25, 0, TOSHIBA_A19NM, NAND_MULTI_PLANE_MODE },
#endif
#ifdef NEW_NAND_SUPPORT
	...
	{"A serials NAND 8GiB SDTNRGAMA-008G ", {NAND_MFR_SANDISK, 0xDE, 0x94, 0x93, 0x76, 0x58}, 16384, 8192, 0x400000, 1280, 1, 20, 25, 0, SANDISK_A19NM, NAND_MULTI_PLANE_MODE},	//for Vccq 1.8v
	{"A serials NAND 4GiB SDTNRFAMA-004G ", {NAND_MFR_SANDISK, 0xD7, 0x84, 0x93, 0x72, 0x58}, 16384, 4096, 0x400000, 1280, 1, 20, 25, 0, SANDISK_A19NM_4G,0},//for Vccq 1.8v
#endif
